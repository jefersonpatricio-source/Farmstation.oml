...
OutSystems Service Studio installed on your machine

Valid OutSystems account credentials

2. Development Platform Access
Username: Agrivetf@gmail.com
...
Capabilities: User management, system configuration, reporting, and all operational functions
...
Access Level: Staff/Operator privileges
...
Valid OutSystems account with appropriate licensing

Network access to OutSystems platform

Deployment Steps
Open Service Studio on your local machine
...
Import the .oml file through File → Import

Publish the module to your target environment

Configure connections to required databases and services
...
Keep Service Studio credentials confidential
